...
col=['\033[1;91m','\033[1;92m','\033[1;93m','\033[1;94m','\033[1;95m','\033[1;96m']
...
def ver_check():
	print(G + '\n[+]' + C + ' Checking for Updates.....', end='')
	ver_url = 'https://raw.githubusercontent.com/sparkz-technology/Missile/master/version.txt'
	try:
...
def tunnel_select():
	if tunnel_mode == None:
		...
		print(G + '[+]' + C + ' starting your own ngrok tunnel service ...' + W + '\n')
	else:
